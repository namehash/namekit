...
export const ColorfulBg = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg viewBox="0 0 1440 370" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <g opacity="0.15">
        <rect y="370" width="370" height="1440" transform="rotate(-90 0 370)" fill="url(#paint0_linear_4888_38355)" />
        <rect y="370" width="370" height="1440" transform="rotate(-90 0 370)" fill="url(#paint1_linear_4888_38355)" />
      </g>
      <defs>

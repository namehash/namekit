...
import { ENSReferralProductComponent } from "@/components/2 - molecules/ens-referral-product-component";
    ...
    <main className="flex w-full flex-col items-center justify-between">
      <div className="mt-20 w-full">
        <div className="w-full lg:px-[50px] px-5 bg-gray-50 flex items-center justify-center">
          <section className="w-full max-w-[1216px] lg:py-[100px] py-[50px]">
            <ENSReferralProductComponent
              title="ENSv2 Referral Programs"
              subtitle="ENSv2 and Namechain unblock practical feasibility for ENS Referral Programs. The future of ENSv2 Referral Programs are not only permissionless to participate in, but also permissionless to create and fund."
              illustration={
                <Image
                  quality={100}
                  width={1056}
                  ...
                  src="/images/ens-v2-referral-programs.svg"
                  alt="hero"
                />
              }

...
export const NormalizedNameNftAvatar = (props: SVGProps<SVGSVGElement>) => {
  /*
    Due to the existance of multiple instances of this component in the same page,
    we need to generate a unique ID for each instance so that the SVG filters don't clash.
  */

import { EnsManagerLogo } from "@/components/atoms/icons/explore-web3-lp/ens-manager-logo";
...
export const IdentitySection = () => {
  return (
    <ExploreWeb3CardsSection
      title="Manage your web3 identity"
      subtitle="Automatically update your profile across hundreds of web3 apps. Express yourself with custom avatar images, a bio, and so much more!"
      label={{
        icon: (
          <svg
      ...
      apps={[
        {
          ...
          illustration: (
            <Image
              ...
              height={140}
              alt="rainbow"
              src={"/images/explore-web3/Illustration-rainbow.png"}
            />
          ),
          gradient: "#FFF3F3",
        ...
        },
        {
          ...
          illustration: (
            <Image
              ...
              height={140}
              alt="ensmanager"
              src={"/images/explore-web3/Illustration-ensmanager.png"}
            />
          ),
          gradient: "#F0F4FF",

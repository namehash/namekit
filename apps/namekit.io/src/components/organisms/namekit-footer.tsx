...
export const NamekitFooter = () => {
  return (
    <footer className="px-6 border-t border-gray-200 pt-5 pb-4 md:pb-[18px] md:pt-6">
      <div className="flex flex-col space-y-7 md:space-y-0 items-start md:items-center md:flex-row max-w-[1216px] mx-auto justify-between">
        <div className="w-full md:w-auto inline-flex items-center justify-between">

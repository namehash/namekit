    ...
    <div className="py-12 max-w-7xl mx-auto px-6 space-y-12">
      <div className="divide-y divide-gray-100">
        ...
        <div className="divide-y divide-gray-100">
          ...
          <div className="grid grid-cols-6 gap-x-6 py-5">
            <div className="flex items-center font-mono">
              <pre>{"<CheckIcon \n withTooltip={false} />"}</pre>
            </div>

            <div className="flex items-center justify-center">
              <CheckIcon code={CheckResultCode.pass} withTooltip={false} />
            </div>
            <div className="flex items-center justify-center">
              <CheckIcon code={CheckResultCode.warn} withTooltip={false} />
            </div>
            <div className="flex items-center justify-center">
              <CheckIcon code={CheckResultCode.alert} withTooltip={false} />
            </div>
            <div className="flex items-center justify-center">
              <CheckIcon code={CheckResultCode.info} withTooltip={false} />
            </div>
            <div className="flex items-center justify-center">
              <CheckIcon code={CheckResultCode.skip} withTooltip={false} />
            </div>
          </div>
        </div>
        <div className="grid grid-cols-6 gap-x-6 py-5 mt-8">
          ...
          <div className="flex items-center justify-center">
            <ReportBadge name="notrab.eth" error={true} />
          </div>
          <div className="flex items-center justify-center">
            <ReportBadge />
          </div>
        ...
        <div className="grid grid-cols-6 gap-x-6 py-5">
          ...
          <div className="flex items-center justify-center">
            <ReportBadge name="lightwalker.eth" error={true} />
          </div>
          <div className="flex items-center justify-center">
            <ReportBadge name="culturecafé.eth" error={true} />
          </div>
          <div className="flex items-center justify-center">
            <ReportBadge name="‍420.eth" error={true} />
          </div>
          <div className="flex items-center justify-center">
            <ReportBadge name="notrab.eth" error={true} />
          </div>
          <div className="flex items-center justify-center">
            <ReportBadge error={true} />
          </div>
        </div>
        <div className="grid grid-cols-6 gap-x-6 py-5">
          <div className="flex items-center">
            <div className="flex items-center font-mono">
              <pre>{"<ReportBadge /> \nwith no data passed"}</pre>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center">
            <ReportBadge name="‍420.eth" onClick={() => alert("Clicked")} />
          </div>
          <div className="flex items-center justify-center">
            <ReportBadge
              error={true}

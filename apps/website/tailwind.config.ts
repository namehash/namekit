  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "exit_section_background" : "linear-gradient(0deg, rgba(255, 255, 255, 0.00) 2.25%, #FFF 96.18%), linear-gradient(90deg, #FFAF00 0%, #F112D9 32.29%, #4C3FA0 70.83%, #2ED3C6 95.83%)",
      },
      screens: {
        'mobile': '375px',
      },

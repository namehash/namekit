  ...
  return (
    <Fragment>
      <Tooltip
        trigger={
          <button
            className="ng-flex ng-items-center ng-justify-between ng-p-2 ng-appearance-none ng-bg-transparent hover:ng-bg-black/5 ng-transition ng-rounded-md focus:ng-outline-none"
            onClick={() => setIsOpen(true)}
          >
            <ArrowUpTrayIcon className="ng-text-black ng-fill-current ng-w-6 ng-h-6" />
            <span className="ng-font-medium ng-ml-1.5 ng-text-sm hidden md:ng-inline-block">
              Share
            </span>
          </button>
        }
        ...
        >
          ...
          <div className="ng-fixed ng-inset-0 ng-z-20 ng-overflow-y-auto">
            <Transition.Child
              as={Fragment}
              enter="ng-ease-out ng-duration-300"
              enterFrom="ng-opacity-0 ng-translate-y-3"
              enterTo="ng-opacity-100 ng-scale-100"
              leave="ng-ease-in ng-duration-200"
              leaveFrom="ng-opacity-100 ng-scale-100"
              leaveTo="ng-opacity-0 ng-translate-y-3"
            >
              <div className="ng-relative ng-z-50 ng-flex ng-items-center ng-justify-center ng-min-h-screen ng-p-6 md:ng-p-0">
                <Dialog.Panel className="ng-w-full md:ng-max-w-sm ng-mx-auto ng-relative ng-transform ng-overflow-scroll ng-rounded-xl ng-bg-white md:ng-bg-gray-100 md:ng-shadow-2xl ng-transition-all ng-flex ng-flex-col">
                  <div className="ng-h-[56px] md:ng-h-[68px] ng-flex ng-items-center md:ng-justify-start ng-px-6 ng-pb-3 md:ng-pb-0 ng-pt-3 md:ng-pt-2 ng-text-center ng-relative">
                    ...
                    <div className="ng-flex ng-items-center ng-right-0 ng-inset-y-0 ng-absolute ng-pr-6 ng-z-20">
                      ...
                      >
                        <XMarkIcon className="ng-w-6 ng-h-6 ng-fill-current ng-text-gray-400" />
                      </button>
                    </div>
                  </div>

                  <div className="ng-min-h-[200px] ng-flex ng-items-center ng-justify-center ng-px-6 md:ng-px-10">
                    {name && (
                      <>
                        <DisplayedName
                          name={buildENSName(name)}
                          textStylingClasses="ng-font-extrabold ng-text-black ng-text-xl"
                        />
                      </>
                    )}
                  </div>

                  <div className="ng-bg-white ng-px-6 ng-py-6 ng-flex ng-flex-wrap ng-justify-between">
                    <a
                      href={twitterLink}
                      target="_blank"
                      rel="noreferrer noopener"
                      className="ng-flex ng-flex-col ng-space-y-3 ng-items-center ng-group"
                      onClick={closeModal}
                    >
                      <div className="ng-rounded-full ng-bg-gray-100 ng-h-10 ng-w-10 ng-flex ng-items-center ng-justify-center">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="20"
                          height="20"
                          viewBox="0 0 24 24"
                          className="ng-fill-current ng-text-gray-400 group-hover:ng-text-gray-900"
                        >
                      ...
                      <span className="ng-text-black ng-text-xs">X.com</span>
                    </a>
                    <a
                      href={telegramLink}
                      target="_blank"
                    ...
                    >
                      ...
                      <span className="ng-text-black ng-text-xs">Email</span>
                    </a>
                    <button
                    ...
                    >
                      <div className="ng-rounded-full ng-bg-gray-100 ng-h-10 ng-w-10 ng-flex ng-items-center ng-justify-center">
                        <svg
                          ...
                          fill="none"
                          xmlns="http://www.w3.org/2000/svg"
                          className="ng-stroke-current ng-text-gray-400 group-hover:ng-text-gray-900"
                        >
                          <path
                      ...
                      <span className="ng-text-black ng-text-xs">
                        Copy link
                      </span>
                    </button>
                  </div>

 ...
 * The data is taken directly from the Unicode standard.
 */
 ...
 * The data is taken directly from the Unicode data files.
 */
 ...
 * The blocks are generated from the Unicode data files.
 */

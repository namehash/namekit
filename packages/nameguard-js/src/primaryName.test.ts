...
import { SecurePrimaryNameResult, securePrimaryName } from "./securePrimaryName";
...
describe("secure primary name", () => {
    it("should detect impersonation", async () => {
        ...
        for (let i = 0; i < results.length; i++) {
            ...
            expect(r.impersonationStatus !== null ? ImpersonationStatus[r.impersonationStatus] : null).toBe(impersonationStatus?.toUpperCase());
            expect(PrimaryNameStatus[r.primaryNameStatus]).toBe(primaryNameStatus.toUpperCase());

...
import { isEncodedLabelhash, isKeccak256Hash, normalizeEncodedLabelhash, normalizeKeccak256Hash } from "./hashutils";

describe("isKeccak256Hash", () => {

    it("valid Keccak256Hash: with prefix all lowercase", () => {
        const result = isKeccak256Hash("0x0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef");

        expect(result).toBe(true);
    });

    it("valid Keccak256Hash: without prefix all lowercase", () => {
        const result = isKeccak256Hash("0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef");
    ...
    it("invalid Keccak256Hash: too long", () => {
        const result = isKeccak256Hash("0x0123456789ABCDEF0123456789abcdef0123456789abcdef0123456789abcdef0");

        expect(result).toBe(false);
    });

    it("invalid Keccak256Hash: too short", () => {
        const result = isKeccak256Hash("0x0123456789ABCDEF0123456789abcdef0123456789abcdef0123456789abcde");

        expect(result).toBe(false);
    });

    it("invalid Keccak256Hash: invalid character", () => {
        const result = isKeccak256Hash("0xx123456789ABCDEF0123456789abcdef0123456789abcdef0123456789abcdef");
...
describe("isEncodedLabelhash", () => {  
    ...
    it("valid EncodedLabelhash: with prefix all lowercase", () => {
        const result = isEncodedLabelhash("[0x0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef]");

        expect(result).toBe(true);
    });

    it("valid EncodedLabelhash: without prefix all lowercase", () => {
        const result = isEncodedLabelhash("[0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef]");
    ...
    it("invalid EncodedLabelhash: too long", () => {
        const result = isEncodedLabelhash("[0x0123456789ABCDEF0123456789abcdef0123456789abcdef0123456789abcdef0]");

        expect(result).toBe(false);
    });

    it("invalid EncodedLabelhash: too short", () => {
        const result = isEncodedLabelhash("[0x0123456789ABCDEF0123456789abcdef0123456789abcdef0123456789abcde]");

        expect(result).toBe(false);
    });

    it("invalid EncodedLabelhash: invalid character", () => {
        const result = isEncodedLabelhash("[0xx123456789ABCDEF0123456789abcdef0123456789abcdef0123456789abcdef]");
...
describe("normalizeKeccak256Hash", () => {  
    ...
    it("normalizeKeccak256Hash: identity -> with prefix", () => {
        const result = normalizeKeccak256Hash("0x0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef", true);

        expect(result).toBe("0x0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef");
    });

    it("normalizeKeccak256Hash: no prefix -> with prefix", () => {
        const result = normalizeKeccak256Hash("0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef", true);
    ...
    it("normalizeKeccak256Hash: identity -> without prefix", () => {
        const result = normalizeKeccak256Hash("0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef", false);
    ...
    it("normalizeKeccak256Hash: with prefix -> without prefix", () => {
        const result = normalizeKeccak256Hash("0x0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef", false);
...
describe("normalizeEncodedLabelhash", () => {  
    ...
    it("normalizeEncodedLabelhash: with prefix", () => {
        const result = normalizeEncodedLabelhash("[0x0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef]");

        expect(result).toBe("[0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef]");
    });

    it("normalizeEncodedLabelhash: without prefix", () => {
        const result = normalizeEncodedLabelhash("[0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef]");

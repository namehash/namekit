...
import { buildENSName, getDecentralizationStatus, getDisplayLabels, getNamespaceRoot, getNormalizationStatus, getRegistrationPotential, isValidDNSTld, labelsEqual, tryNormalize } from "./ensname";
...
describe("getDisplayLabels", () => {
    ...
    it("unnormalized labels", () => {
        ...
        expect(result).toStrictEqual(["[4df76579a9591eddc67216d59dea04a50539665b0fba6c038590357f27f37487]", "eth"]);
    });

    it("unknown labels with mixed case and prefix", () => {
        const result = getDisplayLabels(["[0X4Df76579a9591eddc67216d59dea04a50539665b0fba6c038590357f27f37487]", "eth"]);
...
describe("tryNormalize", () => {
    ...
    it("unknown labels with mixed case and prefix", () => {
        const result = tryNormalize(["[0X4Df76579a9591eddc67216d59dea04a50539665b0fba6c038590357f27f37487]", "eth"]);
...
describe("getNormalizationStatus", () => {
    ...
    it("unknown labels", () => {
        const result = getNormalizationStatus(["[4df76579a9591eddc67216d59dea04a50539665b0fba6c038590357f27f37487]", "eth"]);

        expect(result).toBe("unknown");
    });

    it("unnormalized and unknown values", () => {
        const result = getNormalizationStatus(["[4df76579a9591eddc67216d59dea04a50539665b0fba6c038590357f27f37487]", "invalid|name", "eth"]);
...
describe("getRegistrationPotential", () => {  
    ...
    it("ENS 2nd-level name unknown", () => {
        const result = getRegistrationPotential(buildENSName("[0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef].eth"));

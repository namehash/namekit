...
A TypeScript SDK for interacting with the NameGenerator APIs, providing access to the world's largest collection of word-wiki names. This SDK enables easy integration with the NameGenerator API endpoints for name and collection suggestions.

...
export const DomainMenu = ({ domainCard }: DomainMenuProps) => {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="nk-absolute nk-left-0 nk-z-20 nk-mt-1.5 nk-w-64 nk-origin-top-right nk-rounded-md nk-bg-white nk-shadow-lg nk-ring-1 nk-ring-black nk-ring-opacity-5 focus:nk-outline-none nk-py-2"

...
@pytest.mark.parametrize(
    ...
    [
        ('0x495f947276749ce646f68ac8c248420045cb7b5e', '61995921128521442959106650131462633744885269624153038309795231243542768648193', FakeENSCheckStatus.IMPERSONATED_ETH_NAME),  # fake nick.eth
        ('0x2cc8342d7c8bff5a213eb2cde39de9a59b3461a7', '45104', FakeENSCheckStatus.IMPERSONATED_ETH_NAME),
        ('0x495f947276749ce646f68ac8c248420045cb7b5e', '115299889408293060529275095010636973531920388509401805939660647627196198813697', FakeENSCheckStatus.IMPERSONATED_ETH_NAME),
        pytest.param('0x495f947276749ce646f68ac8c248420045cb7b5e', '87268313074833894749413679830860625010141738974859681274795075557252109697025', FakeENSCheckStatus.IMPERSONATED_ETH_NAME, marks=pytest.mark.xfail(reason='wrong collection name returned by Alchemy?')),  # based on collection name
        ('0xbc4ca0eda7647a8ab7c2061c2e118a18a936f13d', '3972', FakeENSCheckStatus.NON_IMPERSONATED_ETH_NAME),
        ('0xbd3531da5cf5857e7cfaa92426877b022e612cf8', '2028', FakeENSCheckStatus.NON_IMPERSONATED_ETH_NAME),
        ('0xbd3531da5cf5857e7cfaa92426877b022e612cf9', '2028', FakeENSCheckStatus.UNKNOWN_NFT),  # NOT_A_CONTRACT
        ('0x57f1887a8bf19b14fc0df6fd9b2acc9af147ea85', '47192814855232171824620094590612668126513223473283784600320596656451859494352', FakeENSCheckStatus.AUTHENTIC_ETH_NAME),  # brantly.eth
        ('0x57f1887a8bf19b14fc0df6fd9b2acc9af147ea85', '0X68562Fc74af4dcfac633a803c2f57c2b826827b47f797b6ab4e468dc8607b5d0', FakeENSCheckStatus.AUTHENTIC_ETH_NAME),  # brantly.eth uppercase hex
        ('0x57f1887a8bf19b14fc0df6fd9b2acc9af147ea85', '0x68562fc74af4dcfac633a803c2f57c2b826827b47f797b6ab4e468dc8607b5d0', FakeENSCheckStatus.AUTHENTIC_ETH_NAME),  # brantly.eth
        ('0x57f1887a8bf19b14fc0df6fd9b2acc9af147ea85', '0xaf498306bb191650e8614d574b3687c104bc1cd7e07c522954326752c6882770', FakeENSCheckStatus.POTENTIALLY_AUTHENTIC_ETH_NAME),  # unknown but registered #TODO 'title': '[0xaf49...2770].eth'
        ('0X57F1887a8bf19b14fc0df6fd9b2acc9af147ea85', '47192814855232171824620094590612668126513223473283784600320596656451859494352', FakeENSCheckStatus.AUTHENTIC_ETH_NAME),  # brantly.eth uppercase hex
        ('0X57F1887a8bf19b14fc0df6fd9b2acc9af147ea85', '0x37bf77d30d63cbf9ddad6b3c161522c53dcdcd8177b6177c83835c5ea69a7f8f', FakeENSCheckStatus.POTENTIALLY_AUTHENTIC_ETH_NAME),  # random ENS name
        ('0xfe4f558a0fee0657bfa044792f5545f5a8f4ecb1', '1', FakeENSCheckStatus.IMPERSONATED_ETH_NAME),  # https://rarible.com/token/0xfe4f558a0fee0657bfa044792f5545f5a8f4ecb1:1
        ('0xd4416b13d2b3a9abae7acd5d6c2bbdbe25686401', '34762977820481521209114130776556072772965907316729597364642457029530388725237', FakeENSCheckStatus.AUTHENTIC_ETH_NAME),  # NameWrapper https://rarible.com/token/0xd4416b13d2b3a9abae7acd5d6c2bbdbe25686401:34762977820481521209114130776556072772965907316729597364642457029530388725237
        ('0xd4416b13d2b3a9abae7acd5d6c2bbdbe25686401', '0x37bf77d30d63cbf9ddad6b3c161522c53dcdcd8177b6177c83835c5ea69a7f8f', FakeENSCheckStatus.POTENTIALLY_AUTHENTIC_ETH_NAME),  # NameWrapper random ENS name
        pytest.param('0x495f947276749Ce646f68AC8c248420045cb7b5e', '7432975079437310392139769917906933533429658990679450758216769878461532602369', FakeENSCheckStatus.IMPERSONATED_ETH_NAME, marks=pytest.mark.xfail(reason='why not works? it is on x2y2 but delisted on opensea')),  # https://x2y2.io/eth/0x495f947276749Ce646f68AC8c248420045cb7b5e/7432975079437310392139769917906933533429658990679450758216769878461532602369
        ('0x47dD5F6335FfEcBE77E982d8a449263d1e501301', '79', FakeENSCheckStatus.IMPERSONATED_ETH_NAME),  # https://x2y2.io/eth/0x47dD5F6335FfEcBE77E982d8a449263d1e501301/79
        ('0x2Cc8342d7c8BFf5A213eb2cdE39DE9a59b3461A7', '8107', FakeENSCheckStatus.IMPERSONATED_ETH_NAME),  # https://x2y2.io/eth/0x2Cc8342d7c8BFf5A213eb2cdE39DE9a59b3461A7/8107
        ('0xd8B287885cAb9E377de8F61f000Ff9B3F50e2F4d', '4', FakeENSCheckStatus.IMPERSONATED_ETH_NAME),  # https://foundation.app/@rogerhaus/vitalik/4
        ('0xd8B287885cAb9E377de8F61f000Ff9B3F50e2F4d', '0x4', FakeENSCheckStatus.IMPERSONATED_ETH_NAME),  # token id as hex
        ('0x6B175474E89094C44Da98b954EedeAC495271d0F', '1', FakeENSCheckStatus.UNKNOWN_NFT),  # NO_SUPPORTED_NFT_STANDARD
        ('0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2', '1', FakeENSCheckStatus.UNKNOWN_NFT),  # NO_SUPPORTED_NFT_STANDARD
        ('0xA478c2975Ab1Ea89e8196811F51A7B7Ade33eB11', '1', FakeENSCheckStatus.UNKNOWN_NFT),  # NO_SUPPORTED_NFT_STANDARD
        # matic chain is not supported now
        # ('0x2953399124f0cbb46d2cbacd8a89cf0599974963', '1075136997460547214433646341011567219464027878285908866916833491623281164289', FakeENSCheckStatus.IMPERSONATED_ETH_NAME),
        # ('0x2953399124f0cbb46d2cbacd8a89cf0599974963', '3741242716829664262552727484824431817099747563526660400091605301110364962817', FakeENSCheckStatus.IMPERSONATED_ETH_NAME),
        # ('0xcc6c63044bfe4e991f3a13b35b6ee924b54cd304', '440', FakeENSCheckStatus.NON_IMPERSONATED_ETH_NAME),
    ]
)

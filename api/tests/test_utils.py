...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "taoli.eth",
            "0x0000044a32f0964f4bf8fb4d017e230ad33595c0e149b6b2d0c34b733dcf906a",
        ),  # leading zero
        (
            "nIcK.eTh",
            "0xfcbdde3892e62a9ce1495d580fb7d43a8a7b493189aaa9ea72e9a755b355099a",
        ),  # normalizable
        (
            "&　󠁡�‍.eth",
            "0xade50cc78bd67478314cecd9b3623250de7b3d1d962e8df15b063fe365249c4b",
        ),  # disallowed
...
def test_validate_namehash():
    ...
    nh_int = (
        112517680702295317964235270576596002882395863411652297708683208617071958887470
    )
    ...
    with pytest.raises(
        InvalidNameHash
    ):  # converted to base-16 should have at most 64 digits
        _ = validate_namehash(str(nh_int**9))

    with pytest.raises(InvalidNameHash):  # invalid hex-string
        _ = validate_namehash(
            "0xg8c2c01d386a4807b3ceb131e4975ff37b44824ac9307121b18223f3d77d0c2e"
        )
